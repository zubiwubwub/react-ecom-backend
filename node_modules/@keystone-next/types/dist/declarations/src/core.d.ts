...
export declare type KeystoneAdminUIConfig = {
    ...
    path?: string;
    getAdditionalFiles?: ((config: KeystoneConfig, system: KeystoneSystem) => MaybePromise<AdminFileToWrite[]>)[];
    pageMiddleware?: (args: {
        req: IncomingMessage;
        session: any;
...
export declare type KeystoneSystem = {
