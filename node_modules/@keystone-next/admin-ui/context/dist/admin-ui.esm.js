...
function useAdminMeta(adminMetaHash, fieldViews) {
  ...
  const runtimeAdminMeta = useMemo(() => {
    ...
    adminMeta.lists.forEach(list => {
      runtimeAdminMeta.lists[list.key] = _objectSpread2(_objectSpread2({}, list), {}, {
      ...
      list.fields.forEach(field => {
        ...
        runtimeAdminMeta.lists[list.key].fields[field.path] = _objectSpread2(_objectSpread2({}, field), {}, {
          views,
