...
function useAdminMeta(adminMetaHash, fieldViews) {
  ...
  const runtimeAdminMeta = React.useMemo(() => {
    ...
    adminMeta.lists.forEach(list => {
      runtimeAdminMeta.lists[list.key] = objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, list), {}, {
      ...
      list.fields.forEach(field => {
        ...
        runtimeAdminMeta.lists[list.key].fields[field.path] = objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, field), {}, {
          views,
