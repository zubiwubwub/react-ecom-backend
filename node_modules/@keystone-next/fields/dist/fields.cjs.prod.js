...
var fieldsMongoid = require('@keystonejs/fields-mongoid');
var fieldsAutoIncrement = require('@keystonejs/fields-auto-increment');
...
const autoIncrement = (config = {}) => ({
  type: fieldsAutoIncrement.AutoIncrement,
  config,
  views: resolveView('integer/views')
});
