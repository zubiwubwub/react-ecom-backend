...
var SignoutButton = require('./SignoutButton-7d887a6b.cjs.prod.js');
...
const AuthenticatedItem = ({
  ...
  return core.jsx("div", {
    ...
    triggerRenderer: ({
      triggerProps
    }) => core.jsx(button.Button, _extends__default['default']({
      size: "small",
      style: {
        padding: 0,
        width: 36
...
const PageWrapper = props => {
  ...
  return core.jsx(React.Fragment, null, core.jsx("style", null, `body { overflow: hidden; }`), core.jsx("div", _extends__default['default']({
    css: {
...
const Sidebar = props => {
  // const { colors } = useTheme();
  return core.jsx("aside", _extends__default['default']({
    css: {
...
const Content = props => {
  ...
  return core.jsx("main", _extends__default['default']({
    css: {
