...
var types_relationship_views_RelationshipSelect_dist_fields = require('../RelationshipSelect/dist/fields.cjs.prod.js');
...
function InlineEdit({
  ...
  }, props => core.jsx(button.Button, _extends__default['default']({}, props, saveButtonProps, {
...
const CardContainer = (_ref) => {
  let {
    mode = 'view'
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["mode"]);

  const {
    tones
  } = core.useTheme();
  const tone = tones[mode === 'edit' ? 'active' : mode === 'create' ? 'positive' : 'passive'];
  return core.jsx(core.Box, _extends__default['default']({
    paddingLeft: "xlarge",
    css: {
      position: 'relative',
      ':before': {
  ...
  return core.jsx(core.Stack, {
    ...
    return value.itemsBeingEdited.has(id) && onChange !== undefined ? core.jsx(CardContainer, {
      ...
      onSave: newItemGetter => {
        setItems(objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, items), {}, {
          [id]: newItemGetter
        }));
    ...
    }, props => core.jsx(button.Button, _extends__default['default']({
      size: "small",
      disabled: onChange === undefined,
      onClick: () => {
        ...
        if (itemsToFetchAndConnect.length) {
          try {
            ...
            if (isMountedRef.current) {
              ...
              let newItems = objectSpread2._objectSpread2({}, items);
...
function LinkToRelatedItems({
  ...
  if (value.kind === 'many') {
    return core.jsx(button.Button, _extends__default['default']({}, commonProps, {
