      ...
      Mutation: {
        async [gqlNames.createInitialItem](rootVal, {
          ...
          const item = await itemAPI.createOne({
            data: _objectSpread2(_objectSpread2({}, data), itemData),
            resolveFields: false
          });
          const sessionToken = await context.startSession({
            listKey,
...
const getSchemaExtension = ({
  ...
  magicAuthLink,
  gqlNames
})].filter(x => x).reduce((s, extension) => mergeSchemas(_objectSpread2({
  schemas: [s]
}, extension)), schema);
/**
 * createAuth function
...
function createAuth({
  ...
  const additionalListFields = {
    [`${secretField}ResetToken`]: password(_objectSpread2({}, fieldConfig)),
    [`${secretField}ResetIssuedAt`]: timestamp(_objectSpread2({}, fieldConfig)),
    [`${secretField}ResetRedeemedAt`]: timestamp(_objectSpread2({}, fieldConfig)),
    [`magicAuthToken`]: password(_objectSpread2({}, fieldConfig)),
    [`magicAuthIssuedAt`]: timestamp(_objectSpread2({}, fieldConfig)),
    [`magicAuthRedeemedAt`]: timestamp(_objectSpread2({}, fieldConfig))
  };
  /**
   * adminPageMiddleware
   *
  ...
  const withAuth = keystoneConfig => {
    ...
    if (keystoneConfig.ui) {
      ui = _objectSpread2(_objectSpread2({}, keystoneConfig.ui), {}, {
    ...
    return _objectSpread2(_objectSpread2({}, keystoneConfig), {}, {
      ui,
      ...
      lists: _objectSpread2(_objectSpread2({}, keystoneConfig.lists), {}, {
        [listKey]: _objectSpread2(_objectSpread2({}, keystoneConfig.lists[listKey]), {}, {
          fields: _objectSpread2(_objectSpread2({}, keystoneConfig.lists[listKey].fields), additionalListFields)
        })
      }),
