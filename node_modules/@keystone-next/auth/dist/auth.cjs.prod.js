...
function getInitFirstItemSchema({
  ...
  return {
    ...
    resolvers: {
      Mutation: {
        async [gqlNames.createInitialItem](rootVal, {
          data
        }, context) {
          if (!context.startSession) {
            throw new Error('No session implementation available on context');
          ...
          const item = await itemAPI.createOne({
            data: objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, data), itemData),
            resolveFields: false
          });
          const sessionToken = await context.startSession({
            listKey,
...
const getSchemaExtension = ({
  ...
  magicAuthLink,
  gqlNames
})].filter(x => x).reduce((s, extension) => merge.mergeSchemas(objectSpread2._objectSpread2({
  schemas: [s]
}, extension)), schema);
/**
 * createAuth function
...
function createAuth({
  ...
  const additionalListFields = {
    [`${secretField}ResetToken`]: fields.password(objectSpread2._objectSpread2({}, fieldConfig)),
    [`${secretField}ResetIssuedAt`]: fields.timestamp(objectSpread2._objectSpread2({}, fieldConfig)),
    [`${secretField}ResetRedeemedAt`]: fields.timestamp(objectSpread2._objectSpread2({}, fieldConfig)),
    [`magicAuthToken`]: fields.password(objectSpread2._objectSpread2({}, fieldConfig)),
    [`magicAuthIssuedAt`]: fields.timestamp(objectSpread2._objectSpread2({}, fieldConfig)),
    [`magicAuthRedeemedAt`]: fields.timestamp(objectSpread2._objectSpread2({}, fieldConfig))
  };
  /**
   * adminPageMiddleware
   *
  ...
  const withAuth = keystoneConfig => {
    ...
    if (keystoneConfig.ui) {
      ui = objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, keystoneConfig.ui), {}, {
    ...
    return objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, keystoneConfig), {}, {
      ui,
      ...
      lists: objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, keystoneConfig.lists), {}, {
        [listKey]: objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, keystoneConfig.lists[listKey]), {}, {
          fields: objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, keystoneConfig.lists[listKey].fields), additionalListFields)
        })
      }),
