  ...
  return () => {
    const _createSession = createSession(),
      ...
      get
          ...
          sessionStrategy = _objectWithoutProperties__default['default'](_createSession, ["get"]);

    return objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, sessionStrategy), {}, {
      get: async ({
        req,
        createContext
      }) => {
        ...
        try {
          ...
          return objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, session), {}, {
            data: item
          });
        } catch (e) {
  ...
  return () => {
    ...
    return asSessionStrategy({
      ...
      async start({
        ...
        let sealedData = await Iron__default['default'].seal(data, secret, objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, ironOptions), {}, {
          ttl: maxAge * 1000
        }));
...
function storedSessions(_ref) {
  let {
    ...
    maxAge = MAX_AGE
      ...
      statelessSessionsOptions = _objectWithoutProperties__default['default'](_ref, ["store", "maxAge"]);
  ...
  return () => {
    ...
    } = statelessSessions(objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, statelessSessionsOptions), {}, {
      maxAge
    }))();
