...
function withItemData(createSession, fieldSelections = {}) {
  return () => {
    ...
    return _objectSpread2(_objectSpread2({}, sessionStrategy), {}, {
      get: async ({
        req,
        createContext
      }) => {
        ...
        try {
          ...
          return _objectSpread2(_objectSpread2({}, session), {}, {
            data: item
          });
        } catch (e) {
  ...
  return () => {
    ...
    return asSessionStrategy({
      ...
      async start({
        ...
        let sealedData = await Iron.seal(data, secret, _objectSpread2(_objectSpread2({}, ironOptions), {}, {
          ttl: maxAge * 1000
        }));
...
function storedSessions(_ref) {
  ...
  return () => {
    ...
    } = statelessSessions(_objectSpread2(_objectSpread2({}, statelessSessionsOptions), {}, {
      maxAge
    }))();
