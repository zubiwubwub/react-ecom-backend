...
function createGraphQLSchema(config, keystone) {
    ...
    'MapperKind.OBJECT_TYPE'(type) {
      if (config.lists[type.name] !== undefined && config.lists[type.name].fields._label_ === undefined) {
        let _type$toConfig = type.toConfig(),
            fields = _objectWithoutProperties__default['default'](_type$toConfig.fields, ["_label_"]),
            objectTypeConfig = _objectWithoutProperties__default['default'](_type$toConfig, ["fields"]);

        return new graphql.GraphQLObjectType(objectSpread2._objectSpread2({
          fields
        }, objectTypeConfig));
      }
  ...
  graphQLSchema = merge.mergeSchemas(objectSpread2._objectSpread2({
    schemas: [graphQLSchema]
    ...
    findOne(_ref) {
      let {
        resolveFields = 'id'
          ...
          rawArgs = _objectWithoutProperties__default['default'](_ref, ["resolveFields"]);
    ...
    findMany(_ref2) {
      let {
        resolveFields = 'id'
          ...
          rawArgs = _objectWithoutProperties__default['default'](_ref2, ["resolveFields"]);

      const args = getArgs.findMany(rawArgs);

      if (resolveFields) {
        return serverSideGraphqlClient.getItems(objectSpread2._objectSpread2({
          listKey,
          context,
          returnFields: resolveFields
        }, args));
    ...
    createOne(_ref3) {
      let {
        resolveFields = 'id'
          ...
          rawArgs = _objectWithoutProperties__default['default'](_ref3, ["resolveFields"]);
    ...
    createMany(_ref4) {
      let {
        resolveFields = 'id'
          ...
          rawArgs = _objectWithoutProperties__default['default'](_ref4, ["resolveFields"]);
    ...
    updateOne(_ref5) {
      let {
        resolveFields = 'id'
          ...
          rawArgs = _objectWithoutProperties__default['default'](_ref5, ["resolveFields"]);
    ...
    updateMany(_ref6) {
      let {
        resolveFields = 'id'
          ...
          rawArgs = _objectWithoutProperties__default['default'](_ref6, ["resolveFields"]);
    ...
    deleteOne(_ref7) {
      let {
        resolveFields = 'id'
          ...
          rawArgs = _objectWithoutProperties__default['default'](_ref7, ["resolveFields"]);
    ...
    deleteMany(_ref8) {
      let {
        resolveFields = 'id'
          ...
          rawArgs = _objectWithoutProperties__default['default'](_ref8, ["resolveFields"]);
...
function makeCreateContext({
  ...
  const createContext = ({
    ...
    const contextToReturn = objectSpread2._objectSpread2(objectSpread2._objectSpread2(objectSpread2._objectSpread2({
      schemaName: 'public'
...
function createKeystone(config, dotKeystonePath, script) {
  ...
  if (db.adapter === 'knex') {
    ...
    adapter = new adapterMongoose.MongooseAdapter(objectSpread2._objectSpread2({
      mongoUri: db.url
    }, db.mongooseOptions));
  } else if (db.adapter === 'prisma_postgresql') {
    adapter = new adapterPrisma.PrismaAdapter(objectSpread2._objectSpread2({
  ...
  Object.entries(lists).forEach(([key, {
    ...
    keystone$1.createList(key, {
      fields: Object.fromEntries(Object.entries(fields).map(([key, {
        type,
        config
      }]) => [key, objectSpread2._objectSpread2({
        type
      }, config)])),
      access,
      queryLimits: graphql === null || graphql === void 0 ? void 0 : graphql.queryLimits,
...
function applyIdFieldDefaults(config) {
  ...
  Object.keys(config.lists).forEach(key => {
    ...
    idField = objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, idField), {}, {
      config: objectSpread2._objectSpread2({
        ui: objectSpread2._objectSpread2({
          createView: objectSpread2._objectSpread2({
            fieldMode: 'hidden'
          }, (_idField$config$ui = idField.config.ui) === null || _idField$config$ui === void 0 ? void 0 : _idField$config$ui.createView),
          itemView: objectSpread2._objectSpread2({
            fieldMode: 'hidden'
    ...
    const fields$1 = objectSpread2._objectSpread2({
      id: idField
    }, listConfig.fields);

    lists[key] = objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, listConfig), {}, {
      fields: fields$1
    });
  });
  return lists;
...
function initConfig(config) {
  return objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, config), {}, {
